...
public class ReportStoreProductsController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            InputStream storeProductReportStream = classLoader.getResourceAsStream("store_products.jrxml");

            // Compile the report to a JasperReport object
            JasperReport jasperReport = JasperCompileManager.compileReport(storeProductReportStream);
