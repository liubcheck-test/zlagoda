...
public class ReportCategoriesController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            InputStream categoryReportStream = classLoader.getResourceAsStream("categories.jrxml");

            // Compile the report to a JasperReport object
            JasperReport jasperReport = JasperCompileManager.compileReport(categoryReportStream);
