...
public class ReportProductsController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            InputStream productReportStream = classLoader.getResourceAsStream("products.jrxml");

            // Compile the report to a JasperReport object
            JasperReport jasperReport = JasperCompileManager.compileReport(productReportStream);
