...
public class ReportChecksController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            InputStream checkReportStream = classLoader.getResourceAsStream("checks.jrxml");

            // Compile the report to a JasperReport object
            JasperReport jasperReport = JasperCompileManager.compileReport(checkReportStream);
