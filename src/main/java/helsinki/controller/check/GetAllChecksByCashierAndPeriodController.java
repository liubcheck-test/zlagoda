...
public class GetAllChecksByCashierAndPeriodController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        String chosenCashierId = req.getParameter("cashierId");
        if (chosenCashierId != null) {
            req.setAttribute("chosenCashierId", chosenCashierId);
        }
        req.getRequestDispatcher("/WEB-INF/views/checks/find_all_by_cashier_and_period.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        String cashierId = req.getParameter("cashier");
